...
## Corpus Check
- 184 files · ~38,669 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1032 nodes · 949 edges · 135 communities (106 shown, 29 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 10 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6a07c411`
- Run `git rev-parse HEAD` and compare to check if the graph is stale.
- Run `graphify update .` after code changes (no API cost).

## Community Hubs (Navigation)
- [[_COMMUNITY_参考输出基线|参考输出基线]]
- [[_COMMUNITY_codex-plugin-cc 架构基线报告|codex-plugin-cc 架构基线报告]]
- [[_COMMUNITY_Click：可组合命令行运行时的架构基线|Click：可组合命令行运行时的架构基线]]
- [[_COMMUNITY_Claude Code 源码架构基线|Claude Code 源码架构基线]]
- [[_COMMUNITY_OpenAI Codex 架构分析基线|OpenAI Codex 架构分析基线]]
- [[_COMMUNITY_HTTPX 架构分析基线|HTTPX 架构分析基线]]
- [[_COMMUNITY_stark-repo-analyzer-skill 保真移植与 Graphify 增强任务分解|stark-repo-analyzer-skill 保真移植与 Graphify 增强任务分解]]
- [[_COMMUNITY_Ruff 架构分析基线|Ruff 架构分析基线]]
- [[_COMMUNITY_08 Insights|08 Insights]]
- [[_COMMUNITY_Sessionturn orchestration|Session/turn orchestration]]
- [[_COMMUNITY_03 Research|03 Research]]
- [[_COMMUNITY_核心模块：命令模型与上下文执行|核心模块：命令模型与上下文执行]]
- [[_COMMUNITY_核心模块：参数解析与类型转换|核心模块：参数解析与类型转换]]
- [[_COMMUNITY_06 Module Authentication, Decoding and Error Propagation|06 Module: Authentication, Decoding and Error Propagation]]
- [[_COMMUNITY_06 Module Request Entry and Client Orchestration|06 Module: Request Entry and Client Orchestration]]
- [[_COMMUNITY_HTTPX Standard Baseline Execution Log|HTTPX Standard Baseline Execution Log]]
- [[_COMMUNITY_Ruff 项目研究|Ruff 项目研究]]
- [[_COMMUNITY_模块：CLI 与执行控制|模块：CLI 与执行控制]]
- [[_COMMUNITY_模块：项目配置与文件发现|模块：项目配置与文件发现]]
- [[_COMMUNITY_模块：Formatter document pipeline|模块：Formatter document pipeline]]
- [[_COMMUNITY_模块：Lint pipeline 与规则修复|模块：Lint pipeline 与规则/修复]]
- [[_COMMUNITY_Execution Log Click Baseline Run|Execution Log: Click Baseline Run]]
- [[_COMMUNITY_03 Plan|03 Plan]]
- [[_COMMUNITY_Core Module Query Loop|Core Module: Query Loop]]
- [[_COMMUNITY_Core Module Tool Runtime|Core Module: Tool Runtime]]
- [[_COMMUNITY_Execution Log|Execution Log]]
- [[_COMMUNITY_研究与定位|研究与定位]]
- [[_COMMUNITY_模块计划与报告叙事|模块计划与报告叙事]]
- [[_COMMUNITY_核心模块：终端交互与帮助输出|核心模块：终端交互与帮助输出]]
- [[_COMMUNITY_03 Research：Codex 的问题、定位与组织动机|03 Research：Codex 的问题、定位与组织动机]]
- [[_COMMUNITY_05 Modules Plan：按业务功能组织报告|05 Modules Plan：按业务功能组织报告]]
- [[_COMMUNITY_CLITUI user loop|CLI/TUI user loop]]
- [[_COMMUNITY_08 Insights：架构洞察|08 Insights：架构洞察]]
- [[_COMMUNITY_阶段 3：分析计划|阶段 3：分析计划]]
- [[_COMMUNITY_核心模块：Codex App Server 会话运行时|核心模块：Codex App Server 会话运行时]]
- [[_COMMUNITY_核心模块：命令与任务编排|核心模块：命令与任务编排]]
- [[_COMMUNITY_03 Research HTTPX|03 Research: HTTPX]]
- [[_COMMUNITY_06 Module Request, Response, Content and Multipart Models|06 Module: Request, Response, Content and Multipart Models]]
- [[_COMMUNITY_06 Module Transport Contract and Execution Adapters|06 Module: Transport Contract and Execution Adapters]]
- [[_COMMUNITY_06 Module URL, Query Parameters and Runtime Configuration|06 Module: URL, Query Parameters and Runtime Configuration]]
- [[_COMMUNITY_Ruff standard 分析计划|Ruff standard 分析计划]]
- [[_COMMUNITY_模块：Python parsing frontend|模块：Python parsing frontend]]
- [[_COMMUNITY_Ruff standard 基线执行日志|Ruff standard 基线执行日志]]
- [[_COMMUNITY_Stark Repo Analyzer V1 Implementation Goal|Stark Repo Analyzer V1 Implementation Goal]]
- [[_COMMUNITY_物理基线状态|物理基线状态]]
- [[_COMMUNITY_分析计划 Click CLI Framework|分析计划: Click CLI Framework]]
- [[_COMMUNITY_调研笔记 Click CLI Framework|调研笔记: Click CLI Framework]]
- [[_COMMUNITY_ADR 0001 Bounded Standard Scope for a Leaked Source Mirror|ADR 0001: Bounded Standard Scope for a Leaked Source Mirror]]
- [[_COMMUNITY_Core Module Command and Skill Extension|Core Module: Command and Skill Extension]]
- [[_COMMUNITY_Core Module Context and Memory|Core Module: Context and Memory]]
- [[_COMMUNITY_Core Module Task and Agent Runtime|Core Module: Task and Agent Runtime]]
- [[_COMMUNITY_08 Insights|08 Insights]]
- [[_COMMUNITY_洞察与评价|洞察与评价]]
- [[_COMMUNITY_执行日志|执行日志]]
- [[_COMMUNITY_Execution safety boundary|Execution safety boundary]]
- [[_COMMUNITY_Codex standard 基线执行日志|Codex standard 基线执行日志]]
- [[_COMMUNITY_核心模块：Claude 生命周期与 Stop review gate|核心模块：Claude 生命周期与 Stop review gate]]
- [[_COMMUNITY_核心模块：Job 状态、日志与后台生命周期|核心模块：Job 状态、日志与后台生命周期]]
- [[_COMMUNITY_阶段 8：架构洞察|阶段 8：架构洞察]]
- [[_COMMUNITY_执行日志：codex-plugin-cc standard baseline|执行日志：codex-plugin-cc standard baseline]]
- [[_COMMUNITY_05 Modules Plan HTTPX|05 Modules Plan: HTTPX]]
- [[_COMMUNITY_06 Module CLI and Public API Contract|06 Module: CLI and Public API Contract]]
- [[_COMMUNITY_次要模块：语义、LSP 与 ty|次要模块：语义、LSP 与 ty]]
- [[_COMMUNITY_05 Modules Plan|05 Modules Plan]]
- [[_COMMUNITY_Secondary Module Entry and Terminal UI|Secondary Module: Entry and Terminal UI]]
- [[_COMMUNITY_Secondary Module MCP and Plugins|Secondary Module: MCP and Plugins]]
- [[_COMMUNITY_Secondary Module Remote, IDE and Platform Services|Secondary Module: Remote, IDE and Platform Services]]
- [[_COMMUNITY_07 Cross Validation|07 Cross Validation]]
- [[_COMMUNITY_08 Coverage|08 Coverage]]
- [[_COMMUNITY_分析计划|分析计划]]
- [[_COMMUNITY_次要模块：completion、测试与平台基础设施|次要模块：completion、测试与平台基础设施]]
- [[_COMMUNITY_交叉验证|交叉验证]]
- [[_COMMUNITY_03 Plan：standard 分析计划|03 Plan：standard 分析计划]]
- [[_COMMUNITY_MCP、skills 与 plugins|MCP、skills 与 plugins]]
- [[_COMMUNITY_Protocolevent contract|Protocol/event contract]]
- [[_COMMUNITY_07 Cross-validation：交叉验证|07 Cross-validation：交叉验证]]
- [[_COMMUNITY_08 Coverage：覆盖率汇总|08 Coverage：覆盖率汇总]]
- [[_COMMUNITY_阶段 3：项目调研|阶段 3：项目调研]]
- [[_COMMUNITY_阶段 5：模块计划与报告叙事线|阶段 5：模块计划与报告叙事线]]
- [[_COMMUNITY_核心模块：共享 App Server Broker|核心模块：共享 App Server Broker]]
- [[_COMMUNITY_阶段 7：交叉验证|阶段 7：交叉验证]]
- [[_COMMUNITY_阶段 8：覆盖率汇总|阶段 8：覆盖率汇总]]
- [[_COMMUNITY_03 Plan HTTPX Standard Analysis|03 Plan: HTTPX Standard Analysis]]
- [[_COMMUNITY_07 Cross-Validation|07 Cross-Validation]]
- [[_COMMUNITY_08 Coverage|08 Coverage]]
- [[_COMMUNITY_Ruff 模块规划与报告大纲|Ruff 模块规划与报告大纲]]
- [[_COMMUNITY_交叉验证|交叉验证]]
- [[_COMMUNITY_Ruff standard 覆盖率汇总|Ruff standard 覆盖率汇总]]
- [[_COMMUNITY_Ruff 架构洞察|Ruff 架构洞察]]
- [[_COMMUNITY_本地参考源码语料|本地参考源码语料]]
- [[_COMMUNITY_Secondary Module Permission and Shell Security|Secondary Module: Permission and Shell Security]]
- [[_COMMUNITY_App-server integration|App-server integration]]
- [[_COMMUNITY_physical-baseline-check.sh|physical-baseline-check.sh]]
- [[_COMMUNITY_Graphify 自动探测必需的 LLM 引擎|Graphify 自动探测必需的 LLM 引擎]]
- [[_COMMUNITY_覆盖率汇总|覆盖率汇总]]
- [[_COMMUNITY_Stark Repo Analyzer Skill Context|Stark Repo Analyzer Skill Context]]
- [[_COMMUNITY_基线从当前工作树开始|基线从当前工作树开始]]
- [[_COMMUNITY_先建立参考输出基线|先建立参考输出基线]]
- [[_COMMUNITY_Graphify 是强制结构证据闸门|Graphify 是强制结构证据闸门]]
- [[_COMMUNITY_使用 Graphify headless CLI 进行自动分析|使用 Graphify headless CLI 进行自动分析]]
- [[_COMMUNITY_Graphify 产物隔离在分析工作区|Graphify 产物隔离在分析工作区]]
- [[_COMMUNITY_按失败类别限制 Graphify 重试|按失败类别限制 Graphify 重试]]
- [[_COMMUNITY_要求健康的 Graphify 图谱|要求健康的 Graphify 图谱]]
- [[_COMMUNITY_源码裁决 Graphify 冲突|源码裁决 Graphify 冲突]]
- [[_COMMUNITY_区分 Graphify 深度提取和分析档位|区分 Graphify 深度提取和分析档位]]
- [[_COMMUNITY_保真参考流程并加入 Graphify|保真参考流程并加入 Graphify]]
- [[_COMMUNITY_复制参考文件并限制 Graphify 修改范围|复制参考文件并限制 Graphify 修改范围]]
- [[_COMMUNITY_Agent 主导 Graphify Bootstrap 并保留密钥边界|Agent 主导 Graphify Bootstrap 并保留密钥边界]]
- [[_COMMUNITY_为 V1 增加 doctor 预检脚本|为 V1 增加 doctor 预检脚本]]
- [[_COMMUNITY_用 doctor 作为低侵入的 Graphify 侧车|用 doctor 作为低侵入的 Graphify 侧车]]
- [[_COMMUNITY_Quality Checks|Quality Checks]]
- [[_COMMUNITY_Domain Glossary|Domain Glossary]]
- [[_COMMUNITY_Codex standard 基线质量检查|Codex standard 基线质量检查]]
- [[_COMMUNITY_次要模块：支撑能力与插件声明|次要模块：支撑能力与插件声明]]
- [[_COMMUNITY_input|input.md]]
- [[_COMMUNITY_STATUS|STATUS.md]]
- [[_COMMUNITY_checks|checks.md]]
- [[_COMMUNITY_checks|checks.md]]
- [[_COMMUNITY_checks|checks.md]]
- [[_COMMUNITY_checks|checks.md]]
- [[_COMMUNITY_分析哲学与思维框架|分析哲学与思维框架]]
- [[_COMMUNITY_cli.py|cli.py]]
- [[_COMMUNITY_Stark Repo Analyzer|Stark Repo Analyzer]]
- [[_COMMUNITY_分析工作流|分析工作流]]
- [[_COMMUNITY_doctor.sh|doctor.sh]]
- [[_COMMUNITY_package.json|package.json]]
- [[_COMMUNITY_Input and Output Contract|Input and Output Contract]]
...
1. `analyze()` - 16 edges
2. `Repo Analyzer` - 12 edges
3. `Repo Analyzer` - 12 edges
...
### Community 44 - "物理基线状态"
Cohesion: 0.50
Nodes (3): Current Evidence Boundary, Gate Rules, Physical Baseline Gate
...
Cohesion: 0.16
Nodes (24): CompletedProcess, Namespace, Path, analyze(), collect_context(), doctor(), feature_questions(), finalize() (+16 more)
...
## Knowledge Gaps
- **699 isolated node(s):** `Repository Agent Rules`, `Related Articles`, `Quick Install`, `Features`, `Trigger Keywords` (+694 more)
...
- **Are the 4 inferred relationships involving `Path` (e.g. with `.test_local_input_records_commit_shape_without_cloning()` and `.test_non_git_local_input_is_rejected()`) actually correct?**
  _`Path` has 4 INFERRED edges - model-reasoned connections that need verification._
- **What connects `Repository Agent Rules`, `Related Articles`, `Quick Install` to the rest of the system?**
