...
| 当前状态 | 当前无 `active` roadmap；最近完成 [代码地图导航](code-map-navigation-roadmap.md)；[默认 Judge 审查机制](default-judge-review-roadmap.md) 已 `completed` |
...
当前无活动 roadmap。被取代的目标文档保留在 `docs/archive/v1-control-plane/`，并带有明确的 `superseded` 标记。
