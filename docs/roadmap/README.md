...
| 当前状态 | 当前 `active`：[GitHub v1.1.1 发布](github-v1.1.1-release-roadmap.md)；最近完成 [GitHub v1.1.0 发布](github-v1.1.0-release-roadmap.md) 与 [代码地图导航](code-map-navigation-roadmap.md) |
...
当前活动 roadmap：[`github-v1.1.1-release-roadmap.md`](github-v1.1.1-release-roadmap.md)。最近完成含 [`github-v1.1.0-release-roadmap.md`](github-v1.1.0-release-roadmap.md)。被取代的目标文档保留在 `docs/archive/v1-control-plane/`。
