...
|---|---|---|
| 当前是否有实施主线 | [roadmap 索引](roadmap/README.md) → [exec plan 索引](exec-plans/README.md) | 活动主线：[GitHub v1.1.0 发布](roadmap/github-v1.1.0-release-roadmap.md)；代码地图导航已 completed|
...
2. 从 roadmap 与 exec plan 目录索引确认是否存在 `active` 文档；当前活动主线为 [GitHub v1.1.0 发布](roadmap/github-v1.1.0-release-roadmap.md)；代码地图导航与 Graphify/Judge 等已是 `completed`。
