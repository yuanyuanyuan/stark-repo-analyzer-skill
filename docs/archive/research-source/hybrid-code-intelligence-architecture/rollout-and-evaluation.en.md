...
Default promotion is a separate decision, not an automatic consequence of canary completion. It requires updated product/acceptance documentation, an explicit compatibility decision for V1 artifacts, and a separately executed real-UAT campaign that follows `docs/dev-rules/real-uat-regression/README.md` in full.
