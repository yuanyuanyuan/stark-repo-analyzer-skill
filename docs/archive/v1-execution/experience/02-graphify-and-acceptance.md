...
**仓库证据：** [V1 Graphify 边界](../../v1-control-plane/stark-repo-analyzer-v1-implementation.md#graphify-and-doctor-boundaries)、[UAT 禁止假通过](../../../dev-rules/real-uat-regression/README.md)。
