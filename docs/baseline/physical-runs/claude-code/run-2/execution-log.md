...
- Graphify extraction used `--max-workers 8 --max-concurrency 8 --token-budget 24000 --api-timeout 120`; AST reached 1,901/1,901 files and semantic extraction completed 1/1 chunk.
- Raw graph: 16,226 nodes and 61,639 edges. Normalized source-locatable sidecar: 16,205 nodes and 61,615 edges. `doctor.sh post-graph` exited 0.
