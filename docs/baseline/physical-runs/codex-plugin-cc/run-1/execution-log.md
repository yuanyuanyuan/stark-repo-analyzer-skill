...
Graphify sidecar: deep extraction produced 469 nodes/1107 edges. The raw graph is preserved as `graphify-out/raw-deep-graph.json`; the normalized source-locatable AST graph has 442 nodes/1074 edges and passed doctor post-graph. The source tree cache generated by Graphify was removed after archiving.
