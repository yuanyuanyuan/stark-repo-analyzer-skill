...
- [`harness-navigation-clarity-plan.md`](harness-navigation-clarity-plan.md) / [`harness-navigation-clarity-progress.md`](harness-navigation-clarity-progress.md)：`completed`；导航清晰度 T1–T5（Judge pass）。
- [`agent-harness-progressive-disclosure-plan.md`](agent-harness-progressive-disclosure-plan.md)：`completed`；Judge pass + harness 校验。
...
当前无活动计划。最近完成含 [`harness-navigation-clarity-plan.md`](harness-navigation-clarity-plan.md)（Judge pass）。最近完成含 [`github-v1.1.1-release-plan.md`](github-v1.1.1-release-plan.md)（`v1.1.2` 纠正发布 + Judge pass）、[`github-v1.1.0-release-plan.md`](github-v1.1.0-release-plan.md) 与代码地图导航。被取代的任务清单保留在 `docs/archive/v1-control-plane/`。

## 最近完成（本轮）

- [`github-v1.1.1-release-plan.md`](github-v1.1.1-release-plan.md) /
  [`github-v1.1.1-release-progress.md`](github-v1.1.1-release-progress.md)：
  `completed`（独立 Judge pass）；纠正发布 `v1.1.2` 与 version-release SOP。
