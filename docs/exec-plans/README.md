...
| 当前状态 | 当前无 `active`；最近完成 [Agent Harness 渐进披露](agent-harness-progressive-disclosure-plan.md)、代码地图导航与 GitHub v1.1.x 发布 |
...
当前无活动计划。最近完成含 [`github-v1.1.1-release-plan.md`](github-v1.1.1-release-plan.md)（`v1.1.2` 纠正发布 + Judge pass）、[`github-v1.1.0-release-plan.md`](github-v1.1.0-release-plan.md) 与代码地图导航。被取代的任务清单保留在 `docs/archive/v1-control-plane/`。
