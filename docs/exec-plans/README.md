...
| 当前状态 | [github-v1-release-plan.md](github-v1-release-plan.md)、[skill-distribution-architecture-plan.md](skill-distribution-architecture-plan.md) 与 [graphify-simplification-plan.md](graphify-simplification-plan.md) 已 `completed` |
...
当前没有活动计划；发布真实外部安装 smoke 或 G5 时需新建对应控制面。被取代的任务清单和实现计划保留在 `docs/archive/v1-control-plane/`，不能覆盖当前合同。
