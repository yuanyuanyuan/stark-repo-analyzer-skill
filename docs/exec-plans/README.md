...
| 当前状态 | 当前 `active`：[GitHub v1.1.1 发布](github-v1.1.1-release-plan.md)；最近完成 [GitHub v1.1.0 发布](github-v1.1.0-release-plan.md) 与 [代码地图导航](code-map-navigation-plan.md) |
...
- [`github-v1.1.1-release-plan.md`](github-v1.1.1-release-plan.md) / [`github-v1.1.1-release-progress.md`](github-v1.1.1-release-progress.md)
...
当前活动计划：[`github-v1.1.1-release-plan.md`](github-v1.1.1-release-plan.md)。最近完成含 [`github-v1.1.0-release-plan.md`](github-v1.1.0-release-plan.md) 与代码地图导航。被取代的任务清单保留在 `docs/archive/v1-control-plane/`。
