...
| 当前状态 | [github-v1-release-plan.md](github-v1-release-plan.md) 为 `blocked`（GitHub 仓库 disabled）；[skill-distribution-architecture-plan.md](skill-distribution-architecture-plan.md) 与 [graphify-simplification-plan.md](graphify-simplification-plan.md) 已 `completed` |
...
- [`github-v1-release-plan.md`](github-v1-release-plan.md) /
  [`github-v1-release-progress.md`](github-v1-release-progress.md)：`blocked`；目标 GitHub 仓库 disabled，首次 `v1.0.0` GitHub 源码 Release 尚未创建。
...
当前发布计划 `github-v1-release-plan.md` 被 GitHub 仓库 disabled 阻塞。被取代的任务清单和实现计划保留在 `docs/archive/v1-control-plane/`，不能覆盖当前合同。
