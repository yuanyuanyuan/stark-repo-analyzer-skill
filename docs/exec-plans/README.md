...
| 当前状态 | [github-v1-release-plan.md](github-v1-release-plan.md) 为 `active`；[skill-distribution-architecture-plan.md](skill-distribution-architecture-plan.md) 与 [graphify-simplification-plan.md](graphify-simplification-plan.md) 已 `completed` |
...
- [`github-v1-release-plan.md`](github-v1-release-plan.md) /
  [`github-v1-release-progress.md`](github-v1-release-progress.md)：`active`；目标仓库已恢复为 Public，首次 `v1.0.0` GitHub 源码 Release 正在执行。
...
当前活动计划为 `github-v1-release-plan.md`。被取代的任务清单和实现计划保留在 `docs/archive/v1-control-plane/`，不能覆盖当前合同。
