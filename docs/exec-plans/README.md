...
| 当前状态 | `active`：[GitHub v1.1.0 发布](github-v1.1.0-release-plan.md)；最近完成 [代码地图导航](code-map-navigation-plan.md) |
...
- [`github-v1.1.0-release-plan.md`](github-v1.1.0-release-plan.md) / [`github-v1.1.0-release-progress.md`](github-v1.1.0-release-progress.md)
...
当前活动：[`github-v1.1.0-release-plan.md`](github-v1.1.0-release-plan.md) / [`github-v1.1.0-release-progress.md`](github-v1.1.0-release-progress.md)。最近完成含代码地图导航与默认 Judge。被取代的任务清单保留在 `docs/archive/v1-control-plane/`。
